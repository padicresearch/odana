const MAX_BLOCK: u128 = 25_000_000;
const INITIAL_REWARD: u128 = 10 * 1_000_000_000 /*TODO: Use TUC constant*/;
const SPREAD: u128 = MAX_BLOCK.pow(4) / INITIAL_REWARD;
const PRECISION_CORRECTION: u128 = 5012475762;
const MAX_SUPPLY_APPROX: u128 = (INITIAL_REWARD * MAX_BLOCK) - (MAX_BLOCK.pow(5) / (5 * SPREAD));// + PRECISION_CORRECTION;
