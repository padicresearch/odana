...
//
// pub struct MorphIntermediate {
//     snapshot: Arc<DB>,
//     account_state: Arc<RwLock<BTreeMap<H160, AccountState>>>,
//     applied_txs: Arc<RwLock<BTreeSet<Transaction>>>,
//     current_root: Arc<RwLock<Hash>>,
// }
//
// impl MorphIntermediate {
//     pub fn new(
//         root: Hash,
//         snapshot: DB,
//     ) -> Self {
...
//             current_root:Arc::new( RwLock::new(root)),
//         }
//     }
// }
//
...
//
// impl StateDB for MorphIntermediate {
